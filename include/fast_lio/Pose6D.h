...
struct Pose6D_
{
  ...
  Pose6D_(const ContainerAllocator& _alloc) : offset_time(0.0), acc(), gyr(), vel(), pos(), rot()
  {
    (void)_alloc;
    acc.assign(0.0);
...
{
  return lhs.offset_time == rhs.offset_time && lhs.acc == rhs.acc && lhs.gyr == rhs.gyr && lhs.vel == rhs.vel &&
         lhs.pos == rhs.pos && lhs.rot == rhs.rot;
}
...
struct Printer< ::fast_lio::Pose6D_<ContainerAllocator> >
{
  ...
  static void stream(Stream& s, const std::string& indent, const ::fast_lio::Pose6D_<ContainerAllocator>& v)
  {
